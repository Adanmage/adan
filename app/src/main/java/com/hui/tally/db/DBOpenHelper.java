...
//      向typetb表当中插入元素
        ...
        db.execSQL(sql,new Object[]{"餐點", R.mipmap.ic_canyin,R.mipmap.ic_canyin_fs,0});
        ...
        db.execSQL(sql,new Object[]{"日常用品", R.mipmap.ic_riyongpin,R.mipmap.ic_riyongpin_fs,0});
        ...
        db.execSQL(sql,new Object[]{"醫療保健", R.mipmap.ic_yiliao,R.mipmap.ic_yiliao_fs,0});
        db.execSQL(sql,new Object[]{"住", R.mipmap.ic_zhufang,R.mipmap.ic_zhufang_fs,0});
        db.execSQL(sql,new Object[]{"水電費用", R.mipmap.ic_shuidianfei,R.mipmap.ic_shuidianfei_fs,0});
        db.execSQL(sql,new Object[]{"通訊", R.mipmap.ic_tongxun,R.mipmap.ic_tongxun_fs,0});
        db.execSQL(sql,new Object[]{"交際費用", R.mipmap.ic_renqingwanglai,R.mipmap.ic_renqingwanglai_fs,0});

        db.execSQL(sql,new Object[]{"其他", R.mipmap.in_qt,R.mipmap.in_qt_fs,1});
        db.execSQL(sql,new Object[]{"薪水", R.mipmap.in_xinzi,R.mipmap.in_xinzi_fs,1});
        ...
        db.execSQL(sql,new Object[]{"債務", R.mipmap.in_shouzhai,R.mipmap.in_shouzhai_fs,1});
